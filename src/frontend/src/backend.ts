...
import type { Article as _Article } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async getArticles(arg0: string | null, arg1: string | null): Promise<Array<Article>> {
        if (this.processError) {
            try {
                const result = await this.actor.getArticles(to_candid_opt_n2(this._uploadFile, this._downloadFile, arg0), to_candid_opt_n2(this._uploadFile, this._downloadFile, arg1));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getTrendingTopics(): Promise<Array<string>> {
        if (this.processError) {
            try {
                const result = await this.actor.getTrendingTopics();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
